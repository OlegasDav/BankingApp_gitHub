    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                {
                    options.Authority = "https://securetoken.google.com/bankingapp-1d7fd";
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ValidateIssuer = true,
                        ValidIssuer = "https://securetoken.google.com/bankingapp-1d7fd",
                        ValidateAudience = true,
                        ValidAudience = "bankingapp-1d7fd",
